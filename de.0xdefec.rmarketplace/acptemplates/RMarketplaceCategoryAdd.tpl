...
<div class="mainHeadline">
	<img src="{@RELATIVE_WCF_DIR}icon/bbcodeAddL.png" alt="" />
	<div class="headlineContainer">
		<h2>{lang}wcf.acp.rmarketplace.categories.add{/lang}</h2>
	</div>
</div>
...
<div class="border content">
	<div class="container-1">
		<form method="post" action="index.php?form=RMarketplaceCategoryAdd">
			<fieldset>
				...
				<div class="formElement{if $errorField == 'catName'} formError{/if}" id="nameDiv">
					...
					<div class="formField">
						<input type="text" class="inputText" name="catName" id="catName" value="{$form->catName}" />
				...
				<div class="formElement{if $errorField == 'catOrder'} formError{/if}" id="hrefDiv">
					...
					<div class="formField">
						<input type="text" class="inputText" name="catOrder" id="catOrder" value="{$form->catOrder}" />
				...
				<div class="formElement{if $errorField == 'catParent'} formError{/if}" id="titleDiv">
					...
					<div class="formField">
						<select size="1" name="catParent" id="catParent">
							...
							{htmlOptions options=$categories disableEncoding=true selected=$form->catParent}
						</select>
				...
				<div class="formElement{if $errorField == 'catDescription'} formError{/if}" id="noteDiv">
					...
					<div class="formField">
						<textarea name="catDescription" id="catDescription" cols="40" rows="10">{$form->catDescription}</textarea>
				...
				<div class="formElement{if $errorField == 'catInfo'} formError{/if}" id="infoDiv">
					...
					<div class="formField">
						<textarea name="catInfo" id="catInfo" cols="40" rows="10">{$form->catInfo}</textarea>
				...
				<div class="formElement{if $errorField == 'catIcon'} formError{/if}" id="titleDiv">
					...
					<div class="formField">
						<input type="text" class="inputText" name="catIcon" id="catIcon" value="{$form->catIcon}" />
